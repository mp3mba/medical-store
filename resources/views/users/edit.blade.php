...
<div class="d-flex justify-content-center">
    <form action="{{route('users.update', $user->id)}}" class="px-5 py-2" method="POST" style="width:370px; background-color:white; width:380px">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="country" name="role">
                <option value="{{$user->role}}">Update Role</option>
