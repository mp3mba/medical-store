...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('dashboard')}}" class="brand-link" style="text-decoration: none;">
      ...
      <span class="brand-text font-weight-bold">MSMS</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('medics.index') }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ route('suppliers.index') }}" class="nav-link">
              <i class="fa-solid fa-boxes-packing"></i>              <p>
                Medical Suppliers
              </p>
            </a>
          </li>
  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" id="header-title">Dashboard</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
  ...
  <footer class="main-footer d-flex justify-content-center">
    <strong>Copyright &copy; <span id="tarehe"></span> <span>Swahili Developer</span>.</strong>
    All rights reserved.
  </footer>
...
<script>
  document.getElementById('tarehe').innerHTML = new Date().getFullYear();
</script>
